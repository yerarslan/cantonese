...
function Video(props) {
  ...
  function startRecording(){
    ...
    let link = "https://www.cuhk.edu.hk/eLearning/proj/cantonese-tone/video/A.html";
    if(props.number === 2) {
        link = "https://www.cuhk.edu.hk/eLearning/proj/cantonese-tone/video/B.html"
    }
    if(props.number === 3) {
        link = "https://www.cuhk.edu.hk/eLearning/proj/cantonese-tone/video/C.html"
    }
    if(props.number === 4) {
        link = "https://www.cuhk.edu.hk/eLearning/proj/cantonese-tone/video/D.html"
    }
    if(props.number === 5) {
        link = "https://www.cuhk.edu.hk/eLearning/proj/cantonese-tone/video/5.html"
    }
  ...
  return (
    <div className="Lesson">
        <div className="lesson-menu-top-bar">
            ...
            <h1 className="lesson-menu-top-bar-text">Video</h1>
            <div className="lesson-menu-top-bar-right">
            </div>
        </div>
        <div className="lesson-menu-body">
            <iframe title="iframe-video" className='iframe' src={link}></iframe>
        </div>
    </div>
  );
}
